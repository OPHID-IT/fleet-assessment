...
public class InspectionGetEnlargedImage extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
      ...
      //  Bitmap resizeBitmap = resizeBitmap(Tollgate.bm, Tollgate.bm.getWidth() / 4, Tollgate.bm.getHeight() / 4);
        ((ImageView) findViewById(R.id.inspectiongetlargeimage)).setImageBitmap(VehicleInspectionFragment.bm);
